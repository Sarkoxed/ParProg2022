...
from timing_old import ts as ts_old
...
eff_ds = [[x[0], x[1] / x[0], "MPI"] for x in acc_ds]

exp_ts = [[x[0], x[1], "OpenMP"] for x in ts_old]
exp_acc = [[x[0], t_succ1 * 1000 / x[1], "OpenMP"] for x in ts_old]
exp_eff = [[x[0], x[1] / x[0], "OpenMP"] for x in exp_acc]
